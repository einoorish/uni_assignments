/*
    Зберігаються наступні дані про кожен товар: назва товару; одиниці виміру – кілограми, літри, поштучно, пакунки;
    кількість товару (у відповідних одиницях, дійсне число); дата та час виробництва;
    термін зберігання (кількість діб з дати виробництва, не більше 10 років).
*/
#pragma once
...
class Item {
    ...
    public:
        ...
        std::ofstream& writeToBinStream(std::ofstream& stream);
        std::ifstream& readFromBinStream(std::ifstream& stream);
};
